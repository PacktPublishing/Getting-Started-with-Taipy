...
optimize_data_node = Config.configure_data_node(
    id="optimization_target", default_data="price"
)
...
no_country_list_data_node_config = Config.configure_data_node(  ###### Add this
    id="no_country_list", default_data=[]
)
price_per_km_data_node_config = Config.configure_data_node(
    id="price_per_km", default_data=4
)
...
create_pulp_model_task_config = Config.configure_task(
    ...
    input=[
        ...
        no_country_list_data_node_config,  ################## Add this for answer 3

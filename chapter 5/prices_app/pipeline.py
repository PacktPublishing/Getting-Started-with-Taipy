...
if __name__ == "__main__":
    ...
    print(f"The price for December with is {round(price_december, 2)}")
    ...
    print(f"The value of december_buying_price's Data Node is: {december_buying_price}")
    ...
    print(f"The value of scenario_december_2's margin_node is {december_2_margin}")
    ...
    print(f"The value of january_buying_price's Data Node is: {january_buying_price}")

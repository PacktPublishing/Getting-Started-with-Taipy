#########################################################
### Answer 5 - modified main.py                       ###
### moove this file to the project's root,            ###
### keep the other 2 files in the /answer_5 directory ###
#########################################################
...
def on_init(state):
    ...
    create_comp_partial(state)  # Add this fon answer 5
...
if __name__ == "__main__":
    ...
    answer_5_partial = gui.add_partial(page="")
    gui.run(
        title="Paris Parks",
